...
//when add new product, dashboard gets inserted in database
...
const createOrRetrieveCustomer = async ({ email, uuid }) => {
  ...
  //if no customer or no prev history
  if (error || !data?.stripe_customer_id) {
    ...
    if (email) customerData.email = email; //string
...
const manageSubscriptionStatusChange = async (
  ...
  //public tables subscription insert
